...
\gate{position against: JWT/OIDC attack literature (alg=none, key confusion, jku)
---individual attacks are known, our contribution is the population-scale contract
and drift view; IaC/config scanners (Checkov, KICS, Semgrep)---pattern matching vs
contract derivation with provenance; consumer-driven contract testing (Pact)---API
shape vs auth verification; misconfiguration measurement studies---our
methodological template; and the emerging MCP/agent-authorization literature.}
