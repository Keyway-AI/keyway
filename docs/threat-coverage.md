...
| DEL-02 | agent | high | delegation-chain / transitive-trust abuse | `analyzer:delegation_chain`, `harness:sibling_resource` | [RFC 8693 OAuth 2.0 Token Exchange](https://datatracker.ietf.org/doc/html/rfc8693); [OWASP Agentic Top 10 (2025)](https://genai.owasp.org/2025/12/09/owasp-genai-security-project-releases-top-10-risks-and-mitigations-for-agentic-ai-security/); [RFC 9700 OAuth 2.0 Security BCP](https://datatracker.ietf.org/doc/html/rfc9700) |
