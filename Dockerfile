...
RUN CGO_ENABLED=0 GOOS=linux go build \
    -ldflags "-s -w \
      -X github.com/architsharma/keyway/internal/version.Version=${VERSION} \
      -X github.com/architsharma/keyway/internal/version.Commit=${COMMIT} \
      -X github.com/architsharma/keyway/internal/version.Date=${DATE}" \
